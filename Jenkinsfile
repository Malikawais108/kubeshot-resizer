pipeline {
    ...
    environment {
        SONARQUBE_ENV = 'MySonarQubeServer'   // Must match the Name in Jenkins → Configure System → SonarQube installations
        SONAR_TOKEN = credentials('SONAR_TOKEN_2') // Your new SonarQube token credential ID
    }
